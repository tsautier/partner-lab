...
## 
#Ibnu Sina RSE - Add iptable NAT the egress traffic from POD
...
#Create Namespace
microk8s kubectl create namespace fortiadc-ingress                                                                                                                                                                                                                                                                                                                                      
  
# Install fortiadc ingress controller into namespace created above
microk8s helm3 install ingress-controller --namespace fortiadc-ingress fortiadc-ingress-controller/fadc-k8s-ctrl
...
echo "alias kubectl='microk8s kubectl'" >> /home/fortinet/.bashrc
source ~/.bashrc
